...
chckUser = () => {
  this.setState({checkUser : JSON.parse(localStorage.getItem('User'))})
}
  ...
  render() {
    ...
    return (
      <div className="pstr-pr">
        <Navbar loggin={this.props.loggin} chk={this.chckUser}/>
        <div className="pstr">
            ...
            return (
              ...
              <Card className="insta-crd" key={post.id} style={{ width: "18rem" }}>
                ...
                <div className="hding">
                  ...
                  <i class="fas fa-ellipsis-v btm"></i>
                </div>
                ...
                <div className="icns">
                  ...
                  <div className="icon bkm"><i class="far fa-bookmark"></i></div>
                </div>
        ...
        <Profile chck = {this.state.checkUser}/>
     </div> 
      </div>
    );
  }
